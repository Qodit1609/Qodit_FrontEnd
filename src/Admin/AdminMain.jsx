  ...
  return (
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <List>
          {['Navbar', 'heroBox','services', 'features', 'aboutUs','testimonials','chooseus'].map((text, index) => (
            <ListItem button onClick={() => showItemsIntable(text)} name={text} key={text}>
              <ListItemIcon>
      ...
      <main className={classes.content}>
        <div className={classes.toolbar} />
        <AdminShowData data={adminShowDataProps} addNewData={addNewData} handleClickOpenEdit={handleClickOpenEdit} deleteFunction={deleteFunction} setTitle={setTitle} setBody={setBody} setAlt={setAlt} setSelectedIdForEdit={setSelectedIdForEdit}  />
      </main>
    </div>
    <div style={{position:'absolute',right:'25px'}}>
     ...
     <CreateDataPopForm handleClose={handleClose} openPopup={openPopup}  addNewData={addNewData} selectedMenuName={selectedMenuName} />

    <EditDataPopForm handleCloseEdit={handleCloseEdit} openPopupEdit={openPopupEdit} selectedMenuName={selectedMenuName} selectedTitle={selectedTitle} selectedBody={selectedBody} selectedAlt={selectedAlt} SelectedIdForEdit={SelectedIdForEdit} />
      </>
  );
}
